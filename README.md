...
[![inch-ci.org](http://inch-ci.org/github/swoosh/swoosh.svg?branch=master&style=flat)](http://inch-ci.org/github/swoosh/swoosh)
...
between modules. Out of the box it comes with adapters for SendGrid, Mandrill,
